...
async function main() {
  ...
  const c4PvTime = new Date(Date.now() + 5000 * 3600 * 1000).toISOString();
  ...
  const testPvTime8 = new Date(Date.now() + 1000 * 3600 * 1000).toISOString();
  ...
  const testPvTime9 = new Date(Date.now() + 2000 * 3600 * 1000).toISOString();
  ...
  const testPvTimeEmp = new Date(Date.now() + 3000 * 3600 * 1000).toISOString();
